 ...
 */
import { generateJumpbyteABogus } from '../sign/a-bogus'
import {
...
import type { QrMfaResponse } from './types'
...
export async function desktopLitePassportFormPost (
  http: DouyinHttp,
  path: string,
  body: Record<string, string>,
): Promise<QrMfaResponse> {
