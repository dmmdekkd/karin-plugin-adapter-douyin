...
import { CREATOR_AID, CREATOR_ORIGIN } from './constants'
...
export function loadMssdkTokenTemplate (
...
export function buildMssdkTokenBody (
  options: BuildMssdkTokenBodyOptions = {},
): string {
 ...
 */
export async function fetchMssdkToken (
  http: DouyinHttp,
