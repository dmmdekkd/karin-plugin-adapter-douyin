...
import { generateABogus, generateJumpbyteABogus } from './a-bogus'
import type { ABogusOptions, BdmsPreset } from './a-bogus'
import { passportNoonUtcTs } from './aid-sign'
import {
  CREATOR_AID,
  CREATOR_ORIGIN,
...
export function buildPassportBaseQuery (
  opts: PassportQueryOptions = {},
...
export function buildDesktopPassportBaseQuery (
  opts: DesktopPassportQueryOptions,
): Record<string, string> {
  return {
